Instance: health-connect-reader
...
* rest.resource[=].searchRevInclude[+] = "Provenance:target"
* rest.resource[=].searchParam[0].name = "postaladdress"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/location-postalAddress"
* rest.resource[=].searchParam[=].type = #string
...
* rest.resource[=].searchParam[=].type = #token
* rest.resource[=].searchParam[+].name = "availability-allday"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/availability-allday"
* rest.resource[=].searchParam[=].type = #token
* rest.resource[=].searchParam[+].name = "availability-daysofweek"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/availability-daysofweek"
* rest.resource[=].searchParam[=].type = #token
* rest.resource[=].searchParam[+].name = "availability-starttime"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/availability-starttime"
* rest.resource[=].searchParam[=].type = #string
* rest.resource[=].searchParam[+].name = "availability-endtime"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/availability-endtime"
* rest.resource[=].searchParam[=].type = #string
...
* rest.resource[=].searchParam[=].type = #string
* rest.resource[=].searchParam[+].name = "prn"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/ProfessionalRegistrationNumber"
* rest.resource[=].searchParam[=].type = #token
...
* rest.resource[=].searchParam[=].type = #token
* rest.resource[=].searchParam[+].name = "practitionername"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/practitioner-officialname"
* rest.resource[=].searchParam[=].type = #string
* rest.resource[=].searchParam[+].name = "practitionerpreferredname"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/practitioner-preferredname"
* rest.resource[=].searchParam[=].type = #string
* rest.resource[=].searchParam[+].name = "prn"
* rest.resource[=].searchParam[=].definition = "http://ns.electronichealth.net.au/hc/SearchParameter/ProfessionalRegistrationNumber"
* rest.resource[=].searchParam[=].type = #token
