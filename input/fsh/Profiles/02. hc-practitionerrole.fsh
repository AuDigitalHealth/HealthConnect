...
* identifier ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/StructureDefinition/hc-practitionerrole"
* identifier ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* identifier ^extension[=].extension[+].url = "code"
...
* identifier[HCLocalIdentifier] ^definition = "Local identifier for the PractitionerRole attributed by Health Connect. Used for system reference and internal business logic."
* identifier[HCLocalIdentifier] only HCLocalIdentifier
* identifier[HCLocalIdentifier] ^short = "Local identifier for the PractitionerRole attributed by HC"
...
* identifier[medicareProvider] ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/StructureDefinition/hc-practitionerrole"
* identifier[medicareProvider] ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* identifier[medicareProvider] ^extension[=].extension[+].url = "code"
...
* code ^extension[=].extension[=].valueCanonical = "http://digitalhealth.gov.au/fhir/hcpd/StructureDefinition/hc-practitionerrole"
* code ^extension[+].url = "http://hl7.org/fhir/StructureDefinition/obligation"
* code ^extension[=].extension[+].url = "code"
...
* extension contains PractitionerRoleCommunication named practitioner-role-communication 0..* MS
...
* extension[HCSuppressed] ^short = "Flag denoting whether the PractitionerRole should be hidden."
* extension[HCSuppressed] ^definition = "A boolean value indicating whether the PractitionerRole should be hidden from display in the Provider Directory."
